...
// 15.12.2020 Придумал способ (жаль не успею реализовать, наверное). При инициализации 
// программы можно сгенерировать матрицы выигрышных комбинаций для выбранного поля,
// потом в зависимости от первого хода человека выбирать подходящую матрицу и 
// следовать ей и выбирать подходящую матрицу в зависимости от последующих ходов человека
